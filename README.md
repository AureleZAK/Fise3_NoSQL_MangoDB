...
```
cd existing_repo
git remote add origin https://devops.telecomste.fr/zak.aurele/NoSQL_MangoDB_Matchs_Foot.git
git branch -M main
...
- [ ] [Set up project integrations](https://devops.telecomste.fr/zak.aurele/NoSQL_MangoDB_Matchs_Foot/-/settings/integrations)
